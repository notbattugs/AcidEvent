...
export default function Overview() {
  return (
    <div className="h-screen w-screen bg-gradient-to-b from-[#5563e6] to-slate-50">
      <div className="flex justify-center">
        <div className="flex items-start justify-between bg-white h-1/2 w-[74%] px-10 py-10 pb-32">
          <div className="flex items-center w-1/2">
            <div className="w-1 h-1 bg-[#5563e6]"></div>
            <h1 className="text-base ml-2 uppercase font-mono">
              Overview
            </h1>
          </div>
          <h1 className="text-2xl font-base w-2/5">
      ...
      <div className="flex justify-center">
        <div className="flex grid-cols-4 gap-1 justify-center w-[74%]">
